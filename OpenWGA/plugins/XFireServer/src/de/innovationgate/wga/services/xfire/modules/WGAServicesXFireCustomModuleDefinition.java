...
import de.innovationgate.wga.services.xfire.WGAServicesXFireCustomServlet;
import de.innovationgate.wga.services.xfire.XFireServiceProperties;

public class WGAServicesXFireCustomModuleDefinition implements ModuleDefinition, KeyBasedModuleDefinition {
    ...
    public String getDescription(Locale locale) {
        return _bundleLoader.getBundle(locale).getString("custom.description");
    }

    public Class<? extends Object> getImplementationClass() {
        return WGAServicesXFireCustomServlet.class;
    }
    ...
    public String getTitle(Locale locale) {
        return _bundleLoader.getBundle(locale).getString("custom.title");
    }
