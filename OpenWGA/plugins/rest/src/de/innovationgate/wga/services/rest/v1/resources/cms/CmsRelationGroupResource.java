...
@XmlRootElement(name=CmsRelationGroupResource.RESOURCE_TYPE)
@XmlDiscriminatorValue(CmsRelationGroupResource.RESOURCE_TYPE)
public class CmsRelationGroupResource extends AbstractRelationGroupResource<CmsContentResource> {
    
    public static final String RESOURCE_TYPE = "relationGroup";

    public CmsRelationGroupResource() {
        super();
        _new = true;
    }
    
    public CmsRelationGroupResource(CmsContentResource parent, WGContent doc, String groupName) {
        super(parent, parent.getURI().path(CmsContentResource.REFLIST_RELATIONGROUPS).path(groupName));
        _doc = doc;
    ...
    public Response put(CmsRelationGroupResource res) throws WGAPIException {
