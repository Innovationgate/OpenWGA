...
public class Level3 implements CS5PatchLevel {
    
    Map<String,CS5Patch> _patchLevel = new HashMap<String,CS5Patch>();
    
    public Level3(WGDatabase patchDB) throws WGAPIException, IOException {

        WGFileContainer patchesFC = patchDB.getFileContainer("patchlevel3");
        _patchLevel.put("jdbc/wgacontentstore/hsql", new SimpleCS5Patch(WGUtils.readString(patchesFC.getFileText("patch_hsqldb.sql"))));
        _patchLevel.put("jdbc/wgacontentstore/mysql", new MySQLEngineDependentPatch(WGUtils.readString(patchesFC.getFileText("patch_mysql.sql"))));
    ...
    public String getDescription() {
        return "Support for hierarchical page reader rights (#00000953)";
    }
