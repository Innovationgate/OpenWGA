...
public class Level1 implements CS5PatchLevel {
    
    Map<String,CS5Patch> _patchLevel = new HashMap<String,CS5Patch>();
    
    public Level1(WGDatabase patchDB) throws WGAPIException, IOException {

        WGFileContainer patchesFC = patchDB.getFileContainer("patchlevel1");
    ...
    public String getDescription() {
        return "Correct portlet/profile items storage, correct page unique names storage, correct index T24_NAME (#00000350)";
    }
