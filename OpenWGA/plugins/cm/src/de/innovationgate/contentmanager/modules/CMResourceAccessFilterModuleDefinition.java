...
import de.innovationgate.contentmanager.filter.ResourceAccessFilter;
...
public class CMResourceAccessFilterModuleDefinition implements ModuleDefinition {
    ...
    public String getDescription(Locale locale) {
        return "A request filter handling authorized access to CM TML modules";
    }
    ...
    public Object getProperties() {
        ...
        mapping.setName("CM Resource Access Filter");
        mapping.setUrlPatterns(Collections.singletonList("/plugin-contentmanager/*"));
        return mapping;
    }

    public String getTitle(Locale locale) {
        return "CM Resource Access Filter";
    }
