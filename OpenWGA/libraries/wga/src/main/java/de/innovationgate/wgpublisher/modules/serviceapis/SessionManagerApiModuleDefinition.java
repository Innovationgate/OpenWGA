...
import de.innovationgate.wga.modules.types.ServiceApiProperties.Fetcher;
...
public class SessionManagerApiModuleDefinition implements ModuleDefinition, KeyBasedModuleDefinition {
    ...
    public String getTitle(Locale locale) {
        return _bundleLoader.getBundle(locale).getString("sessionmanager.title");
    }

    @Override
    public String getDescription(Locale locale) {
        return _bundleLoader.getBundle(locale).getString("sessionmanager.description");
    }
    ...
    public Class<? extends Object> getImplementationClass() {
        return WGAHttpSessionManager.class;
    }
    ...
    public Object getProperties() {
        ...
        props.setFetcher(new Fetcher() {
            @Override
            public Object fetchService(WGA wga) {
                return wga.getCore().getHttpSessionManager();
            }
        });
        return props;
    }
    ...
    public String getRegistrationKey() {
        return WGAHttpSessionManager.class.getName();
    }
