...
/**
 * Type for OpeNWGA scheduler task types
 */
public class SchedulerTaskModuleType implements DeclaringModuleType {

    public String getDescription() {
        return "A type of task for the WGA scheduler";
    }
    ...
    public Class<? extends Object> getPropertyClass() {
        return SchedulerTaskProperties.class;
    }
