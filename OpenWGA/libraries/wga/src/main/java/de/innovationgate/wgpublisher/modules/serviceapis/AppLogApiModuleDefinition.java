...
public class AppLogApiModuleDefinition implements ModuleDefinition, KeyBasedModuleDefinition {
    ...
    public String getTitle(Locale locale) {
        return _bundleLoader.getBundle(locale).getString("applog.title");
    }

    @Override
    public String getDescription(Locale locale) {
        return _bundleLoader.getBundle(locale).getString("applog.description");
    }
    @Override
    ...
    public Object getProperties() {
        ...
        props.setDefaultImplementation(AppLog.class);
        return props;
    }

    @Override
    public String getRegistrationKey() {
        return AppLog.class.getName();
    }
