 ...
 */
public class PersonalisationDatabaseModuleType implements DeclaringModuleType {

    public String getDescription() {
        return "A type of database for storing WGA user profiles";
    }
    ...
    public String getTitle() {
        return "personalisation database type";
    }
