...
import de.innovationgate.webgate.api.PageRightsFilter;
import de.innovationgate.wga.modules.DeclaringModuleType;

public class PageRightsFilterType implements DeclaringModuleType {

    @Override
    public String getTitle() {
        return "Page Rights Filter Type";
    }

    @Override
    public String getDescription() {
        return "Selects Page Rights Filter Implementations";
    }
