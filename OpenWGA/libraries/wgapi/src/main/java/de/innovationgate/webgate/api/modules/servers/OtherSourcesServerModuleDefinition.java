...
public class OtherSourcesServerModuleDefinition implements ModuleDefinition {
    
    private LocalisationBundleLoader _bundleLoader = new LocalisationBundleLoader(WGUtils.getPackagePath(this.getClass()) + "/othersources", getClass().getClassLoader());
    ...
    public Class<? extends Object> getImplementationClass() {
        return OtherSourcesDatabaseServer.class;
    }
    ...
    public Object getProperties() {
        ...
        props.setSingletonTitle("server.title");
