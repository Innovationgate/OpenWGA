 ...
 */
public class AuthenticationSourceModuleType implements DeclaringModuleType {

    public String getDescription() {
        return "Provides authentication service for WGA Content Stores";
    }

    public String getTitle() {
        return "authentication source type";
    }
