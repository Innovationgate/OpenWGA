 ...
 */
public class AnonymousAuthSession implements AuthenticationSession {
	
	private static AnonymousAuthSession _inst = new AnonymousAuthSession();

	private AnonymousAuthSession() {
	    userNames.add(WGDatabase.ANONYMOUS_USER);
	}
