 ...
 * Normally those are picked up and processes periodically by the {@link WGEventThread} 
 */
public interface WGBackendChangeListener {
     ...
     * @param log
     */
    public void processChange(WGDatabase db, WGUpdateLog log);
