 ...
 */
public class WGIllegalDataException extends WGBackendException {
    ...
    public WGIllegalDataException(String msg, Throwable cause) {
        super(msg, cause);
        setRepairable(false);
    }
    
    public WGIllegalDataException(String msg) {
        super(msg);
        setRepairable(false);
    }
