 ...
 *
 */
public interface WGDesignChangeListener {
    
    /**
     * The design of a design core provider or the database has changed.
     * There might be no open database session on the design's database if the event originates from a design provider 
