...
import de.innovationgate.webgate.api.postgresql.PostgresqlEnhancedQuerySource;
...
public class PostgresqlEnhancedQueryDatabaseModuleDefinition extends GenericContentDatabaseModuleDefinition {
    
    private LocalisationBundleLoader _bundleLoader = new LocalisationBundleLoader(WGUtils.getPackagePath(this.getClass()) + "/postgresqlenhancedquerydb", getClass().getClassLoader());
    ...
    public Class<? extends Object> getImplementationClass() {
        return PostgresqlEnhancedQuerySource.class;
    }
    ...
    public Object getProperties() {
        ...
        props.addServerDatabaseRetriever(new PostgresqlServerDatabaseRetriever(false));
    ...
    public void testDependencies() throws ModuleDependencyException {
        try {
            Class.forName(de.innovationgate.webgate.api.postgresql.WGDatabaseImpl.DRIVER);
        }
        catch (ClassNotFoundException e) {
            throw new ModuleDependencyException("The PostgreSQL JDBC Driver " + de.innovationgate.webgate.api.postgresql.WGDatabaseImpl.DRIVER + " is not in classpath");
        }
    }
