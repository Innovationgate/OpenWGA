...
public class PostgresqlPersDBModuleDefinition extends GenericPersonalisationDatabaseModuleDefinition {
    
    private LocalisationBundleLoader _bundleLoader = new LocalisationBundleLoader(WGUtils.getPackagePath(this.getClass()) + "/postgresqlpers", getClass().getClassLoader());
