...
CREATE TABLE contenttype(
		...
		outerlayout VARCHAR(255),
		innerlayout VARCHAR(255),
		positioning VARCHAR(255),
		preferredparent VARCHAR
);
...
CREATE TABLE structentry(
		...
		created DATE NOT NULL,
		lastmodified DATE NOT NULL,
		structposition INTEGER NOT NULL,
		title VARCHAR(255),
		workflow VARCHAR(255),
		parententry_id VARCHAR(32),
		contenttype_id VARCHAR(32),
		webarea_id VARCHAR(32),
...
CREATE TABLE content_relations(
		...
		targetcontent VARCHAR(32),
		relgroup VARCHAR(255)
);
...
CREATE TABLE userprofile(
		...
		client VARCHAR(255),
		login VARCHAR(255),
		profilepassword VARCHAR(255)
);

CREATE TABLE userprofile_items(
		id VARCHAR(32) NOT NULL,
		profile_id VARCHAR(32) NOT NULL,
		portlet_id VARCHAR(32),
		name VARCHAR(200) NOT NULL,
		datatype INTEGER,
		textvalue VARCHAR,
		numbervalue INTEGER,
...
CREATE TABLE userprofile_portlets(
		id VARCHAR(32) NOT NULL,
		portletkey VARCHAR(32),
		profile_id VARCHAR(32) NOT NULL,
		appdb VARCHAR(255),
		designdb VARCHAR(255),
		design VARCHAR(255),
		parentportlet_id VARCHAR(32),
		name VARCHAR(255)
);
...
CREATE TABLE extensiondata(
		...
		numbervalue INTEGER,
		datevalue DATE,
		binaryvalue_sha512 VARCHAR(128)
);
