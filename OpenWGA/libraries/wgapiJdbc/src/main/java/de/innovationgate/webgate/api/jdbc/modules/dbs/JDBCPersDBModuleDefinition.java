...
public class JDBCPersDBModuleDefinition extends GenericPersonalisationDatabaseModuleDefinition {
    
    private LocalisationBundleLoader _bundleLoader = new LocalisationBundleLoader(WGUtils.getPackagePath(this.getClass()) + "/jdbcpers", getClass().getClassLoader());
