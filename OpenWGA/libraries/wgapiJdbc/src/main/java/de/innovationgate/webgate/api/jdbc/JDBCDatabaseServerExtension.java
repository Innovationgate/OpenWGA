...
public interface JDBCDatabaseServerExtension {

	public Connection createJDBCConnection(DatabaseInformation db, Properties props) throws WGAPIException;
    public Connection createJDBCConnection(DatabaseInformation db) throws WGAPIException;    
    public Connection createJDBCConnection() throws WGAPIException;
	...
	public String buildJDBCPath(Map<String, String> options) throws WGAPIException;
