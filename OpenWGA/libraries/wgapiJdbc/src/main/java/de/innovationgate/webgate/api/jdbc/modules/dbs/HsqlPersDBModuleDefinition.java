...
public class HsqlPersDBModuleDefinition extends GenericPersonalisationDatabaseModuleDefinition {

    private LocalisationBundleLoader _bundleLoader = new LocalisationBundleLoader(WGUtils.getPackagePath(this.getClass()) + "/hsqlpers", getClass().getClassLoader());
