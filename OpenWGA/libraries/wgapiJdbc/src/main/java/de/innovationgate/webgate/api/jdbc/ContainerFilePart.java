...
public class ContainerFilePart implements Serializable, AttachmentFilePart {
    ...
    private ContainerFileMeta meta;	
    ...
    public boolean equals(Object other) {
        if ( !(other instanceof ContainerFilePart) ) return false;
        ContainerFilePart castOther = (ContainerFilePart) other;
	...
	public ContainerFileMeta getMeta() {
		return meta;
	}

	public void setParentEntity(Entity meta) {
	    setMeta((ContainerFileMeta) meta);
	}
	
	public void setMeta(CS41FileAttachmentEntity meta) {
	    this.meta = (ContainerFileMeta) meta;
	}
