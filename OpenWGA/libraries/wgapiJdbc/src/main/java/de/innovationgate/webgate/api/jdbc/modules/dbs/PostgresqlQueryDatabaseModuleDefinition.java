...
import de.innovationgate.webgate.api.postgresql.PostgresqlQuerySource;
...
public class PostgresqlQueryDatabaseModuleDefinition extends GenericContentDatabaseModuleDefinition {
    
    private LocalisationBundleLoader _bundleLoader = new LocalisationBundleLoader(WGUtils.getPackagePath(this.getClass()) + "/postgresqlquerydb", getClass().getClassLoader());
    ...
    public Class<? extends Object> getImplementationClass() {
        return PostgresqlQuerySource.class;
    }
