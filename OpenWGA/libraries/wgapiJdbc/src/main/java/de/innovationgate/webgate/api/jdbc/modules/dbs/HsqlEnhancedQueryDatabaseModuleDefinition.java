...
import de.innovationgate.webgate.api.hsql.HsqlEnhancedQuerySource;
...
public class HsqlEnhancedQueryDatabaseModuleDefinition extends GenericContentDatabaseModuleDefinition {
    
    private LocalisationBundleLoader _bundleLoader = new LocalisationBundleLoader(WGUtils.getPackagePath(this.getClass()) + "/hsqlenhancedquerydb", getClass().getClassLoader());
    ...
    public Class<? extends Object> getImplementationClass() {
        return HsqlEnhancedQuerySource.class;
    }
