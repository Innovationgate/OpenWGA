 ...
 */
@Root(strict=false)
public class Task extends IdentifiableConfigBean {
	...
	public Task(String implClassName) {
	    this();
    ...
    public List<ModuleDefinition> getOptionDefinitions(ModuleRegistry registry, PropertyDescriptor property, WGAConfiguration config) {
        ...
        if (property.getName().equals("options")) {
            list.add(registry.getModuleDefinition("de.innovationgate.wga.modules.types.SchedulerTaskModuleType", getImplClassName()));
        }
