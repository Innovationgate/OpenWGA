 ...
 */
public class CommaSeparatedListOptionType extends StringOptionType implements ConvertingOptionType {
    
    public static final CommaSeparatedListOptionType INSTANCE = new CommaSeparatedListOptionType();
