 ...
 */
public class SHA512HashingInputStream extends InputStream {
    
    /**
     * Reads the given input stream and returns the data hash. The input data is not conserved.
    ...
    public static String getStreamHash(InputStream in) throws NoSuchAlgorithmException, IOException {
        ...
        SHA512HashingInputStream hashIn = new SHA512HashingInputStream(new BufferedInputStream(in));
     ...
     * @throws NoSuchAlgorithmException
     */
    public SHA512HashingInputStream(InputStream stream) throws NoSuchAlgorithmException {
        _stream = stream;
        _digest = MessageDigest.getInstance("SHA-512");
    }

    /**
     * Returns the built SHA-512 hash Base64 encoded). The stream must be closed prior to calling this.
     */
    ...
    /**
     * Returns the built SHA-512 hash bytes. The stream must be closed prior to calling this.
     */
