...
public class SHA1HashingSchemeModuleDefinition implements ModuleDefinition, KeyBasedModuleDefinition {
    
    private LocalisationBundleLoader _bundleLoader = new LocalisationBundleLoader(WGUtils.getPackagePath(this.getClass()) + "/sha-1", getClass().getClassLoader());
    ...
    public Class<? extends Object> getImplementationClass() {
        return SHA1HashingScheme.class;
    }
