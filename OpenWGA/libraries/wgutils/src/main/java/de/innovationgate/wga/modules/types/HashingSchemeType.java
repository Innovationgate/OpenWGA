 ...
 */
public class HashingSchemeType implements DeclaringModuleType {

    @Override
    public String getTitle() {
        return "Hashing Scheme Module Type";
    }

    @Override
    public String getDescription() {
        return "Modules defining ways for creating data hashes";
    }
