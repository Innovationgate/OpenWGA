 ...
 */
public class SHA256HashingInputStream extends InputStream {
    ...
    public static String getStreamHash(InputStream in) throws NoSuchAlgorithmException, IOException {
        ...
        SHA256HashingInputStream hashIn = new SHA256HashingInputStream(new BufferedInputStream(in));
     ...
     * @throws NoSuchAlgorithmException
     */
    public SHA256HashingInputStream(InputStream stream) throws NoSuchAlgorithmException {
        _stream = stream;
