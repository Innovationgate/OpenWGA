 ...
 */
public class SpaceSeparatedListOptionType extends StringOptionType implements ConvertingOptionType {
    
    public static final SpaceSeparatedListOptionType INSTANCE = new SpaceSeparatedListOptionType();
